    ...
    <main className="flex-grow">
        ...
        <AnimatedSection className="relative bg-background">
          <div className="grid md:grid-cols-2 gap-0 items-center">
              ...
              <div className="relative aspect-square md:order-1 group overflow-hidden clip-path-zigzag-right">
                 <Image
        ...
        <AnimatedSection className="relative bg-secondary/30">
          <div className="grid md:grid-cols-2 gap-0 items-center">
              <div className="relative aspect-square md:order-2 group overflow-hidden clip-path-zigzag-left">
                 <Image
